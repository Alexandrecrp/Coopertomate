...
require_once("../../classes/control/DistribuidorControl/Consultadistribuidor.php");
require_once("../../classes/control/DistribuidorControl/Cadastrodistribuidor.php");
...
<html lang="pt-br">
    ...
    <body>
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="myNavbar">
				  <ul class="nav navbar-nav">
					...
					<li><a href="listadistribuidor" class="colorwhite">Cadastro distribuidores</a></li>
      ...
      <div class="container">
				<h3 class="page-header">Cadastro de Distribuidor</h3>
				<form method="post" class="form-signin-fluid" name="frmLogin">
					<div class="form-row col-md-12">
						<div class="form-group col-md-6">
							<label for="inputPassword4">Distribuidor</label>
							<input type="text" name="distribuidor" class="form-control" placeholder="Distribuidor" required>
						</div>
					</div>
					<div class="form-row col-md-12">
					...
					<div class="form-row col-md-12">
						<div class="nav navbar-nav navbar-right">
							<input type="submit" name="btnSubmit" value="Cadastrar" class="btn btn-danger"/> <td><a href="listadistribuidor.php"  class="btn btn-default">Voltar</a></td>
						</div>
...
if (isset($_POST['btnSubmit'])) {
	...
	//classe responsável por consultar se usuário existe ou não
		$consultadistribuidor = new ConsultaDistribuidor();
			if (!$consultadistribuidor->consultarDistribuidor($_POST['cnpj'])){
					//classe responsável por cadastrar distribuidor novo
					$cadastradistribuidor = new CadastroDistribuidor($distribuidor);
					$cadastradistribuidor->cadastrarDistribuidor();
		} else {
?>
<script>
	alert("Distribuidor já cadastrada.");
</script>
<?php
	}
}
