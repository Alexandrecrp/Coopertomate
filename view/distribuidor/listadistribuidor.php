...
require_once("../../classes/control/distribuidorControl/ListaDistribuidor.php");
    ...
    <body>
      ...
      <div class="container">
				<div class="nav navbar-nav navbar-right">
					<a href="cadastrodistribuidor.php" class="btn btn-danger"/>Cadastrar Novo Distribuidor</a> <a href="../../painel.php" class="btn btn-default">Voltar</a></td>
				</div>
				<h3 class="page-header">Lista Distribuidores</h3>
				<table class="table table-striped">
					...
					<tbody>
						<?php
							$listadistribuidor = new ListaDistribuidor;
							$resultado = $listadistribuidor->getAll();
							foreach($resultado as $distribuidor) {
						?>
						<tr>
							<th width="50" scope="row">
								<center>
									<?php echo $distribuidor->getId();?>
								</center>
							</th>
							<td width="200">
								<?php	echo	$distribuidor->getDistribuidor();?>
							</td>
							<td width="200">
								<?php echo $distribuidor->getCidade();?>
							</td>
							<td width="400">
								<center>
									<a href="editadistribuidor.php?iddistribuidor=<?php echo $distribuidor->getId();?>" class="btn btn-danger btn-md" role="button">Editar</a>
								</center>
							</td>
						</tr>
						<?php
